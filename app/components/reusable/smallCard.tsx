...
export default function SmallCard({ title, imageUrl, children, className }: Smallprops) {
    return (
        <div className={` ${className} relative border md:px-[12px] gap-6 rounded-[16px] bg-[#1C2727] border-[#0797A0] overflow-hidden flex flex-col items-center opacity-90 justify-center sm:pb-4 pb-6 lg:pt-0 pt-6 2xl:h-[175px] lg:h-[135px] s:h-[170px]`}>
            {imageUrl ? (
