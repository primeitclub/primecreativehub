...
export default function Navbar() {
  ...
  return (
   ...
   {/* <nav className="fixed z-50 flex items-center w-full h-[70px] pt-8 left-1/2 -translate-x-1/2 md:px-[10vw] px-[5vw] gap-6 md:gap-8 bg-[rgba(0,0,0,0)] backdrop-blur-md border-b border-white/10 shadow-lg transition-all duration-300">
      ...
      {/* Logo */}
      <div className="relative w-[40px] h-[40px] md:w-[45px] md:h-[45px] translate-y-[-16px]">
        <Link href="/">
      ...
      {/* Mobile Menu Button */}
      <button
        className="ml-auto md:hidden p-2 -m-2 transition-transform duration-200 hover:scale-110 active:scale-95 translate-y-[-16px]"
      ...
      {/* Desktop Nav Items */}
      <div className="hidden md:flex flex-grow justify-center gap-[40px] translate-y-[-12px]">
