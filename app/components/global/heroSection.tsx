      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center justify-center text-center flex-grow gap-2 2xl:gap-4">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-2 md:gap-4.75 lg:gap-9.5 sm:mt-2 md:mt-3.5 lg:mt-7">
            <SocialIcon
              href="https://justpaste.it/redirect/anfuf/https%3A%2F%2Fwww.instagram.com%2Fprimeitclub%2F"
              src="/images/insta.svg"
              alt="Instagram"
            />
            <SocialIcon
              href="https://justpaste.it/redirect/anfuf/https%3A%2F%2Fgithub.com%2Fprimeitclub"
              src="/images/github.svg"
              alt="GitHub"
            />
            <SocialIcon
              href="https://justpaste.it/redirect/anfuf/https%3A%2F%2Flinkedin.com%2Fcompany%2Fprimeitclub"
