  ...
  return (
    <div className="text-center gap-0 flex max-w-[1920px] flex-col relative items-center">
      ...
      <div className="text-white w-full mt-3">
        ...
        <div className="absolute -bottom-3  md:bottom-4 md:blur-[20px]  sm:blur-[18px]  lg:blur-[20px]  xl:blur-[27px] sm:-bottom-1 xl:-bottom-3 blur-[16px] xs:-bottom-1 left-0 w-full h-[45%] bg-[#020E0F] z-[100] "></div>
