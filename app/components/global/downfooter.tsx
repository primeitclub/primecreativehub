    ...
    <div className="text-center flex flex-col relative items-center">
      ...
      <div className="text-white">
        ...
        <div className=" flex flex-col w-full items-center overflow-hidden">
          <h1
            className="whitespace-nowrap text-[45px] sm:text-[60px] md:text-[95px] lg:text-[160px] xl:text-[180px] 
      ...
      <div className="flex flex-row items-center justify-center w-full h-full bg-black mt-4">
        ...
        <div className=" p-2 text-center z-10 bg-black">
          <p className='text-[16px] sm:text-[18px] md:text-[20px] lg:text-[24px] xl:text-[24px]  '>© 2025 Creative Hub. All rights reserved</p>
        </div>
      </div>
    </div>
  )
