  ...
  return (
    <div className="text-center gap-0 flex w-full flex-col relative items-center">
      ...
      <div className="text-white">
        ...
        <div className="absolute -bottom-1 left-0 w-full h-[45%] bg-[#020E0F] blur-[30px] z-[100]"></div>
      ...
      <div className="flex flex-row items-center relative justify-center w-full h-full z-100">
        <div className=" p-1 text-center justify-center flex relative w-full z-10 bg-black">
          ...
          ></div>
          <p className="text-[16px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px]  ">
