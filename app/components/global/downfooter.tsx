...
export default function Downfooter() {
  return (
    <div className="text-center gap-0 flex w-full flex-col relative items-center">
      ...
      <div className="text-white w-full mt-3">
        ...
        <div className="absolute bottom-0 left-0 w-full h-[55%]  bg-[linear-gradient(180deg,transparent_0%,rgba(0,0,0,0.5)_40%,rgba(0,0,0,1)_100%)]  z-20"></div>
          <h1
            className="whitespace-nowrap  
                       leading-none font-extrabold text-[12vw]
                       bg-[linear-gradient(90deg,#295D60_3.43%,#23C6C6_50.61%,#295D60_95.78%)] 
      ...
      {/* Footer copyright */}
      <div className="flex flex-row items-center relative justify-center w-full h-full ">
      
        <div className="  text-center p-5 justify-center flex relative w-full z-10 bg-black">
        <div className="absolute top-0 left-0 w-full h-[1px] 
              bg-[linear-gradient(91deg,#041213_20.35%,#23C6C6_50%,#041213_80.65%)]"></div>
          <p className='text-[8px] md:text-[12px] 2xl:text-[24px]'>©  2025 Creative Hub. All rights reserved</p>
        </div>
